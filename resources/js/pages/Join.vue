...
<template>
    ...
    <div class="theme-bg theme-text flex min-h-screen flex-col">
        ...
        <main
            class="mx-auto flex w-full max-w-5xl flex-1 flex-col items-center px-4 py-12"
        >
            ...
            >
                <article
                    v-for="tier in tiers"
                    :key="tier.name"
                    class="theme-border theme-text flex flex-col rounded-xl border bg-transparent p-6"
                    :class="{
                        'ring-2 ring-primary ring-offset-2 ring-offset-[var(--bg)]':
                            tier.highlighted,
                    }"
                >
                    ...
                    <ul
                        class="theme-text-dark mt-6 flex flex-1 flex-col gap-3 text-sm"
                    >
                        <li
                ...
                <article
                    class="theme-border theme-text col-span-full flex flex-col items-center rounded-xl border bg-transparent p-6 text-center"
                >
                    <h2 class="theme-text text-lg font-semibold">Custom</h2>
                    <p class="theme-text-dark mt-2 max-w-2xl text-sm">
                        Looking for a fully custom roller, stand-alone or
                        integrated into your own site? Or looking for a fully
                        featured ARPG website? Contact me at
                        <a
